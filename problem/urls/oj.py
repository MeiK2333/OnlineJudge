...
from ..views.oj import ProblemTagAPI, ProblemAPI, ContestProblemAPI, PickOneAPI, ProblemAnswerListAPI
...
urlpatterns = [
    ...
    url(r"^problem/answer/?$", ProblemAnswerListAPI.as_view(), name="problem_answer_api"),
]
